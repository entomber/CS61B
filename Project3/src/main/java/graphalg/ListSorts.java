package graphalg;// my HW 8 solution
...
public class ListSorts {
  ...
  public static LinkedQueue mergeSortedQueues(LinkedQueue q1, LinkedQueue q2) {
    ...
    // while queues are not empty, check items at front
    ...
    // append empty queue to this queue
    if (!q1.isEmpty()) {
  ...
  public static void mergeSort(LinkedQueue q) {
    ...
    // repeatedly remove 2 items from queue of queues, merge them, enqueue the results
    ...
    // when there is only 1 queue left on the queue of queues, move its items back to q
    try {
  ...
  public static void quickSort(LinkedQueue q) {
    ...
    int random = (int) (q.size() * Math.random()) + 1; // random int between 1 and q.size()
